...
export default function Invitation() {
    return (
        <section className="relative bg-paper w-full text-center border-b border-ink-light/20 overflow-hidden">
            ...
            <div className="flex flex-col items-center relative w-full z-10">
                ...
                {/* Couple grid */}
                <div className="grid grid-cols-2 gap-4 md:gap-x-16 w-full max-w-6xl mx-auto mb-14 items-start">
                    {[
                        { role: 'Cô dâu', name: 'Uyển Nhi', saint: 'Lucia', sub: 'Trưởng Nữ', src: '/codau.jpg', alt: 'Cô dâu', quality: 75, x: 40 },
                        { role: 'Chú rể', name: 'Quý Thanh', saint: 'Phêrô', sub: 'Út Nam', src: '/chure.jpg', alt: 'Chú rể', quality: 75, x: -40 },
                    ].map((p, i) => (
                        <motion.div
                            key={i}
                ...
                {/* Quote + Photo + Parents */}
                <div className="w-full max-w-6xl mx-auto mb-8 grid grid-cols-1 md:grid-cols-[320px_1fr] md:grid-rows-2 gap-x-16 gap-y-10 md:gap-y-0 items-center">
                    {/* Quote */}
                    <motion.div
                            ...
                            {[
                                ...
                                >
                                    <div className="h-[90px] md:h-[100px]">
                                        ...
                                        <p className="text-[12px] md:text-xl text-ink font-serif leading-relaxed"><span className="font-semibold">Bố:</span> {f.bo}</p>
                                        <p className="text-[12px] md:text-xl text-ink font-serif leading-relaxed"><span className="font-semibold">Mẹ:</span> {f.me}</p>
                                    </div>
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-6xl md:text-8xl font-serif font-bold text-[#904C4C] leading-none">04</span>
                        <div className="w-px h-8 bg-ink-light/30" />
                ...
                >
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.9, delay: 0.2 }}
                    >
                        <span className="font-serif font-bold text-4xl md:text-6xl text-ink">17:00</span>
                        <div className="w-px h-10 bg-ink-light/40" />
                        <span className="font-serif font-bold text-2xl md:text-4xl text-ink">04/07/2026</span>
                        <div className="w-px h-10 bg-ink-light/40" />
                        <span className="font-serif font-bold text-xl md:text-3xl tracking-widest uppercase text-ink">Thứ Bảy</span>
                    </motion.div>
                    <motion.p
